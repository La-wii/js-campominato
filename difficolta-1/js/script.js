...
while (numPc.length < 16) {
    var randomNum = randomNumbers(1, 80)
...
while (arrayUtente.length < 16 && !lose) {
    // num da 1 a 80
    var numInserito = parseInt(prompt('Inserisci numero da 1 a 80'));
    ...
    } if (numInserito == 0 || numInserito > 80){
        alert('Il numero deve essere tra 1 a 80');
    } else {
