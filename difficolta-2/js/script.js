...
while (numPc.length < 16) {
    var randomNum = randomNumbers(1, 50)
...
// parte utente
// In seguito deve chiedere all’utente (50 - 16) volte di inserire un numero alla volta, sempre compreso tra 1 e 100.  
...
while (arrayUtente.length < 16 && !lose) {
    // num da 1 a 50
    var numInserito = parseInt(prompt('Inserisci numero da 1 a 50'));
    ...
    } if (numInserito == 0 || numInserito > 50){
        alert('Il numero deve essere tra 1 a 50');
    } else {
